...
public abstract class WebSocketServer extends WebSocketAdapter implements Runnable {
    ...
    public WebSocketServer() throws UnknownHostException {
        this(new InetSocketAddress(8080), DECODERS, null);
    }
     ...
     *
     * @param timeout Specifies how many milliseconds shall pass between initiating the close handshakes with the connected clients and closing the servers socket channel.
    ...
    public abstract void onMessage(WebSocketImpl conn, String message);
     ...
     *
     * @param con Can be null if there error does not belong to one specific websocket. For example if the servers port could not be bound.
     */
