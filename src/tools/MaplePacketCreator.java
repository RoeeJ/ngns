...
public class MaplePacketCreator {
    ...
    private static void addCharStats(final MaplePacketLittleEndianWriter mplew, MapleCharacter chr) {
        ...
        mplew.writeAsciiString(StringUtil.getRightPaddedStr(chr.getDisplayName(), '\0', 13));
    ...
    private static void addCharacterInfo(final MaplePacketLittleEndianWriter mplew, MapleCharacter chr) {
        ...
        addNewYearInfo(mplew);//have fun!
        addAreaInfo(mplew, chr);//assuming it stayed here xd
        mplew.writeShort(0);
    }

    private static void addNewYearInfo(final MaplePacketLittleEndianWriter mplew) {
        mplew.writeShort(0);
        /*  
    ...
    private static void addMiniGameInfo(final MaplePacketLittleEndianWriter mplew) {
        mplew.writeShort(0);
    ...
    public static byte[] getAuthSuccess(MapleClient c) {
        ...
        mplew.writeBool(c.isGM() && c.isClientGM()); //admin byte
//        short toWrite = (short) (c.gmLevel() * 32);
        ...
        mplew.write(Math.min(0x80,toWrite));//0x80 is admin, 0x20 and 0x40 = subgm
        mplew.writeBool(c.isGM() && c.isClientGM());
    ...
    public static byte[] sendTV(MapleCharacter chr, List<String> messages, int type, MapleCharacter partner) {
        ...
        addCharLook(mplew, chr, false);
        mplew.writeMapleAsciiString(chr.getDisplayName());
        if (partner != null) {
            mplew.writeMapleAsciiString(partner.getDisplayName());
        } else {
            mplew.writeShort(0);
        }
    ...
    public static byte[] updatePlayerStats(List<Pair<MapleStat, Integer>> stats) {
        return updatePlayerStats(stats, false,null);
    }
    ...
    public static byte[] getAvatarMega(MapleCharacter chr, String medal, int channel, int itemId, List<String> message, boolean ear) {
        ...
        mplew.writeMapleAsciiString(medal + chr.getDisplayName());
        message.forEach(mplew::writeMapleAsciiString);
    ...
    public static byte[] gachaponMessage(Item item, String town, MapleCharacter player) {
        ...
        mplew.writeShort(SendOpcode.SERVERMESSAGE.getValue());
        mplew.write(0x0B);
        mplew.writeMapleAsciiString(player.getDisplayName() + " : got a(n)");
     ...
     *
     * @param personalExp The amount of EXP gained.
     * @param inChat In the chat box?
     * @param white White text or yellow?
     * @return The exp gained packet.
     */
    public static byte[] getShowExpGain(double personalExp, double equip, boolean inChat, boolean white) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        mplew.writeInt((int)personalExp);
        ...
        mplew.writeInt((int)equip); //equip bonus
    ...
    public static byte[] spawnPlayerMapobject(MapleCharacter chr) {
        ...
        if (chr.getPlayerShop() != null && chr.getPlayerShop().isOwner(chr)) {
            ...
            if (chr.getMiniGame().hasFreeSlot()) {
                addAnnounceBox(mplew, chr.getMiniGame(), 1, 1, 0);
            } else {
                addAnnounceBox(mplew, chr.getMiniGame(), 1, 2, 1);
            }
        } else {
            mplew.write(0);
        }
    ...
    private static void addAnnounceBox(final MaplePacketLittleEndianWriter mplew, MapleMiniGame game, int gametype, int ammount, int joinable) {
    ...
    public static byte[] moveMonster(int useskill, int skill, int skill_1,
                                          int skill_2, int skill_3, int oid, Point startPos,
    ...
    public static byte[] charInfo(MapleCharacter chr) {
        ...
        chr.getCashShop().getWishList().forEach(mplew::writeInt);
        ...
        medalQuests.addAll(completed.stream().filter(q -> q.getQuest().getId() >= 29000).map(q -> q.getQuest().getId()).collect(Collectors.toList()));

        Collections.sort(medalQuests);
        mplew.writeShort(medalQuests.size());
        medalQuests.forEach(mplew::writeShort);
        return mplew.getPacket();
    }
    ...
    private static byte[] getShowInventoryStatus(int mode) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendOpcode.SHOW_STATUS_INFO.getValue());
        mplew.write(0);
        mplew.write(mode);
...
// opposite status
//mapid?
        buddylist.stream().filter(BuddylistEntry::isVisible).forEach(buddy -> {
            mplew.writeInt(buddy.getCharacterId()); // cid
            mplew.writeAsciiString(getRightPaddedStr(buddy.getName(), 13));
            mplew.write(0); // opposite status
            mplew.writeInt(buddy.getChannel() - 1);
            mplew.writeAsciiString(getRightPaddedStr(buddy.getGroup(), 13));
    ...
    public static byte[] requestBuddylistAdd(int cidFrom, int cid, String nameFrom) {
        ...
        mplew.writeInt(cidFrom);
        mplew.writeAsciiString(getRightPaddedStr(nameFrom, 11));
        mplew.write(0x09);
        mplew.write(0xf0);
        mplew.write(0x01);
        mplew.writeInt(0x0f);
    ...
    public static byte[] showGuildInfo(MapleCharacter c) {
        ...
        for (MapleGuildCharacter mgc : members) {
            mplew.writeAsciiString(getRightPaddedStr(mgc.getName(), 13));
    ...
    private static void addThread(final MaplePacketLittleEndianWriter mplew, ResultSet rs) throws SQLException {
    ...
    public static byte[] petChat(int cid, int index, int type, int action, String text, boolean chatBalloon) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static byte[] changePetName(MapleCharacter chr, String newname) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static byte[] getMiniGame(MapleMiniGame minigame, boolean owner, int piece) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendOpcode.PLAYER_INTERACTION.getValue());
        mplew.write(PlayerInteractionHandler.Action.ROOM.getCode());
        mplew.write(1);
    ...
    public static byte[] getMiniGameReady() {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter(3);
        mplew.writeShort(SendOpcode.PLAYER_INTERACTION.getValue());
    ...
    public static byte[] getMiniGameUnReady() {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter(3);
        mplew.writeShort(SendOpcode.PLAYER_INTERACTION.getValue());
    ...
    public static byte[] getMiniGameSkipOwner() {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter(4);
        mplew.writeShort(SendOpcode.PLAYER_INTERACTION.getValue());
    ...
    public static byte[] getMiniGameSkipVisitor() {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter(4);
        mplew.writeShort(SendOpcode.PLAYER_INTERACTION.getValue());
    ...
    public static byte[] getMatchCard(MapleMiniGame minigame, boolean owner, int piece) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendOpcode.PLAYER_INTERACTION.getValue());
        mplew.write(PlayerInteractionHandler.Action.ROOM.getCode());
        mplew.write(2);
    ...
    public static byte[] addOmokBox(MapleCharacter c, int ammount, int type) {
        ...
        mplew.writeShort(SendOpcode.UPDATE_CHAR_BOX.getValue());
        mplew.writeInt(c.getId());
        addAnnounceBox(mplew, c.getMiniGame(), 1, ammount, type);
        return mplew.getPacket();
    }
    ...
    public static byte[] addMatchCardBox(MapleCharacter c, int ammount, int type) {
        ...
        mplew.writeShort(SendOpcode.UPDATE_CHAR_BOX.getValue());
        mplew.writeInt(c.getId());
        addAnnounceBox(mplew, c.getMiniGame(), 2, ammount, type);
        return mplew.getPacket();
    }
    ...
    public static byte[] loadFamily() {
        String[] title = {"feg'o'saurus", "Summon Family", "My Drop Rate 1.5x (15 min)", "My EXP 1.5x (15 min)", "Family Bonding (30 min)", "My Drop Rate 2x (15 min)", "My EXP 2x (15 min)", "My Drop Rate 2x (30 min)", "My EXP 2x (30 min)", "My Party Drop Rate 2x (30 min)", "My Party EXP 2x (30 min)"};
    ...
    public static byte[] getFamilyInfo(MapleFamilyEntry f) {
        ...
        mplew.writeInt(Server.getInstance().getAllChannels().stream().filter(ch -> ch.getPlayerStorage().getCharacterById(f.getChrId()) != null).findFirst().get().getPlayerStorage().getCharacterById(f.getChrId()).getVotePoints());
        mplew.writeInt(Server.getInstance().getAllChannels().stream().filter(ch -> ch.getPlayerStorage().getCharacterById(f.getChrId()) != null).findFirst().get().getPlayerStorage().getCharacterById(f.getChrId()).getVotePoints());
        ...
        mplew.writeMapleAsciiString("NGNS");
        mplew.writeInt(0);
        mplew.writeShort(0);
        return mplew.getPacket();
    }

    public static byte[] showPedigree() {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
     ...
     * @return
     */
    private static byte[] showSpecialEffect(int effect) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendOpcode.SHOW_ITEM_GAIN_INCHAT.getValue());
        mplew.write(effect);
        return mplew.getPacket();
    ...
    public static byte[] getAllianceInfo(MapleAlliance alliance) {
        ...
        alliance.getGuilds().forEach(mplew::writeInt);
    ...
    public static byte[] getGuildAlliances(MapleAlliance alliance) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendOpcode.ALLIANCE_OPERATION.getValue());
        mplew.write(0x0D);
    ...
    public static byte[] addGuildToAlliance(MapleAlliance alliance, int newGuild) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendOpcode.ALLIANCE_OPERATION.getValue());
        mplew.write(0x12);
        mplew.writeInt(alliance.getId());
    ...
    public static byte[] removeGuildFromAlliance(MapleAlliance alliance, int expelledGuild) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendOpcode.ALLIANCE_OPERATION.getValue());
        mplew.write(0x10);
        mplew.writeInt(alliance.getId());
    ...
    public static byte[] addItemToWeddingRegistry(Item item) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendOpcode.WEDDING_GIFT_RESULT.getValue());
        mplew.write(0x0B);
        mplew.writeInt(0);
    ...
    public static byte[] sendGainRep(int gain) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    private static String getRightPaddedStr(String in, int length) {
    ...
    private static void addRingInfo(final MaplePacketLittleEndianWriter mplew, MapleCharacter chr) {
        ...
        for (MapleRing ring : chr.getCrushRings()) {
            ...
            mplew.writeAsciiString(getRightPaddedStr(ring.getPartnerName(), 13));
            mplew.writeInt(ring.getRingId());
            mplew.writeInt(0);
            mplew.writeInt(ring.getPartnerRingId());
            mplew.writeInt(0);
        ...
        if (chr.getMarriageRing() != null) {
            ...
            mplew.writeAsciiString(getRightPaddedStr(chr.getName(), 13));
            mplew.writeAsciiString(getRightPaddedStr(chr.getMarriageRing().getPartnerName(), 13));
        }
    }
    ...
    private static void addCashItemInformation(final MaplePacketLittleEndianWriter mplew, Item item, int accountId) {
        addCashItemInformation(mplew, item, accountId, null);
    }

    private static void addCashItemInformation(final MaplePacketLittleEndianWriter mplew, Item item, int accountId, String giftMessage) {
    ...
    public static byte[] showWishList(MapleCharacter mc, boolean update) {
        ...
        mc.getCashShop().getWishList().forEach(mplew::writeInt);
