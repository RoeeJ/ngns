        ...
        if (operation == Actions.TOSERVER_SEND_ITEM.getCode()) {
            ...
            if (send) {
                ...
                if (recipientOn && rClient != null) {
                    ...
                    rClient.announce(MaplePacketCreator.getWhisper("Mr T.", rClient.getChannel(), "You got mail mothafucka"));
                }
            ...
            try {
                ...
                FilePrinter.printError("duey.txt", e);
            }
            if (dp.getItem() != null) {
