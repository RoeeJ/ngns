...
public final class MoveLifeHandler extends AbstractMovementPacketHandler {
    public final void handlePacket(SeekableLittleEndianAccessor slea,
        ...
        if (skillByte == 1 && monster.getNoSkills() > 0) {
            ...
            toUse = MobSkillFactory.getMobSkill(skillToUse.getLeft(),
                    skillToUse.getRight());
        ...
        //c.getPlayer().dropMessage(String.format("skill_1:%d skill_2:%d skill_3:%d toUse:%s",skill_1,skill_2,skill_3, toUse == null ? "null" : String.valueOf(toUse.getSkillId())));
        if(toUse != null) {
            toUse.applyEffect(c.getPlayer(), monster, true);
        }
        if ((skill_1 >= 100 && skill_1 <= 200)
                && monster.hasSkill(skill_1, skill_2)) {
        ...
        } else if (skill == -1 && monster.isControllerKnowsAboutAggro()
        ...
        if (res != null && slea.available() == 9) {
            c.getPlayer()
                    ...
                    .broadcastMessage(
                            c.getPlayer(),
                            MaplePacketCreator.moveMonster(skillByte, skill,
                                    skill_1, skill_2, skill_3, objectid,
                                    startPos, res), monster.getPosition());
