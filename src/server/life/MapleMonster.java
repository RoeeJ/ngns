...
public class MapleMonster extends AbstractLoadedMapleLife {
    ...
    public void giveExpToCharacter(MapleCharacter attacker, double d, boolean highestDamage, int numExpSharers) {
        if (highestDamage) {
    ...
    public MapleCharacter killBy(MapleCharacter killer) {
        double totalBaseExpL = (this.getExp() * killer.getClient().getPlayer().getExpRate());
    ...
    public void setStolen(BitSet stolen) {
        this.stolen = stolen;
    }
    ...
    private class PartyAttackerEntry implements AttackerEntry {
        ...
        public void killedMob(MapleMap map, int baseExp, boolean mostDamage) {
            ...
            for (Entry<MapleCharacter, Integer> expReceiver : expMap.entrySet()) {
                giveExpToCharacter(expReceiver.getKey(), expReceiver.getValue(), mostDamage && expReceiver.getKey() == highest, expMap.size());
            }
        }
    ...
    public List<Integer> getStolen() { return stolenItems; }
